...
Identity models carry the face, but you should still hold lighting and lens language steady within a scene, since both change how a face reads. Our [how-to guide on character consistency](/docs/how-to/keep_character_ai) covers the full checklist.
