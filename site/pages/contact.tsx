...
type ContactCardProps = { label: string; email: string; description: string };
...
function ContactCard({ label, email, description }: ContactCardProps) {
  return (
    <div style={{
      ...
      <a
        href={`mailto:${email}`}
        style={{ color: "var(--ifm-color-primary)", fontWeight: 600, fontSize: "1.05rem" }}
      >
        {email}
      </a>
...
export default function Contact(): ReactNode {
  return (
    <Layout
      ...
      description="Get in touch with the ACT3 AI team. We'd love to hear from you."
    >
      <main>
        {/* Hero */}
        <section style={{
          ...
          <div className="container" style={{ maxWidth: 700 }}>
            <Heading as="h1" style={{ fontSize: "2.75rem", lineHeight: 1.2, marginBottom: "1rem" }}>
              Contact Us
            </Heading>
        ...
        <section style={{ padding: "4rem 0", borderBottom: "1px solid var(--ifm-color-emphasis-200)" }}>
          <div className="container" style={{ maxWidth: 700 }}>
            <Heading as="h2" style={{ marginBottom: "2rem" }}>Get in Touch</Heading>
            <ContactCard
              label="General Inquiries"
              email="hello@act3ai.com"
              description="Questions about the platform, features, or anything else."
            />
            <ContactCard
              label="Sales & Partnerships"
              email="sales@act3ai.com"
              description="Studio deals, agency partnerships, volume pricing, and custom plans."
            />
            <ContactCard
              label="Support"
              email="support@act3ai.com"
              description="Technical help, billing questions, and account issues."
            />
        ...
        <section style={{ padding: "4rem 0" }}>
          <div className="container" style={{ maxWidth: 700 }}>
            <Heading as="h2" style={{ marginBottom: "1rem" }}>Ready to Start Creating?</Heading>
