...
{/* GENERATED FILE -- do not edit here.
    Source: <seo corpus>/ai_clip_pipeline/ai_clip_pipeline.md
    Regenerate with: node scripts/sync-articles.js */}
# ACT 3 AI vs Runway: Clip Generator or Full Production Pipeline?
...
The honest test is a script with real shot count. **[See how ACT 3 AI compares on your project](/features)** — import a script and let the pipeline build the shot list — or **[book a walkthrough](/contact)** with the ACT 3 team.
