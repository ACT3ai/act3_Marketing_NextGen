...
{/* GENERATED FILE -- do not edit here.
    Source: <seo corpus>/write_ai_shoot/write_ai_shoot.md
...
[ACT 3 AI](/) is built around the idea that you should write the script, and the **prompts should write themselves**. You import a finished script — FDX, PDF, or plain text — or hand the system a high-level premise and let AI story expansion grow it into a full screenplay with beats, scenes and dialogue. From there the automation does the part that breaks human patience:
