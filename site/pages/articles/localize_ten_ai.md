...
{/* GENERATED FILE -- do not edit here.
    Source: <seo corpus>/localize_ten_ai/localize_ten_ai.md
...
**[See how ACT 3 AI handles localization](/)** — one production, per-market voice and lipsync, every placement exported from the same source.
