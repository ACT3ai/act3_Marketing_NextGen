...
article_slug: "sora_after_shutdown"
article_target_query: "sora alternative for filmmakers"
...
{/* GENERATED FILE -- do not edit here.
    Source: <seo corpus>/sora_after_shutdown/sora_after_shutdown.md
...
The right test is not a demo prompt — it is your script. **[See how ACT 3 AI compares on a real project](/features)** by importing the script you were building in Sora, or **[book a walkthrough](/contact)** and have the team run your first act through the pipeline with you.
