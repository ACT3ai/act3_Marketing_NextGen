...
//
// DO NOT edit this file to make homepage changes — edit site/pages/index.tsx.
// To refresh this snapshot: re-copy index.tsx over it and re-apply the three
// differences (component renamed to HomeBackup, "(Backup)" in the <title>, and
...
export default function HomeBackup(): React.JSX.Element {
  useEffect(() => {
